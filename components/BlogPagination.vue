  ...
  <nav aria-label="Nawigacja">
    <ul class="pagination justify-content-center">
      ...
      <li v-if="currentPage > 2" class="page-item">
        <nuxt-link class="page-link" :to="{ name: 'blog-strona-page', params: { page: currentPage -1 } }">
          {{ currentPage - 2 }}
        </nuxt-link>
      </li>
      ...
      <li v-if="currentPage + 2 <= totalPages" class="page-item">
        <nuxt-link class="page-link" :to="{ name: 'blog-strona-page', params: { page: currentPage + 2 } }">
          {{ currentPage + 2 }}
        </nuxt-link>
      </li>
      ...
      <li v-if="currentPage !== totalPages" class="page-item">
        <nuxt-link class="page-link" :to="{ name: 'blog-strona-page',params: { page: totalPages }}">
          Ostatnia
        </nuxt-link>
      </li>
    </ul>
